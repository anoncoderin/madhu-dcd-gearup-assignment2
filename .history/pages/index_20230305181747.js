...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <div className={styles.logo}><img src={'logo/logo/logo.png'} /></div>
        <div className={styles.container}>
          <div className={styles.filters}>
            <br></br>
            <h2>Filter By:</h2>
            <br></br>
            <h3 onClick={() => setSelection(['Male', ''])}>Male</h3>
            ...
            <h3 onClick={() => setSelection(['Unisex', ''])}>Unisex</h3>
            <div className={styles.list}>
              <li onClick={() => setSelection(['Unisex', 'Jackets'])}>Jackets</li>
              <li onClick={() => setSelection(['Unisex', 'Headgear'])}><a href="">Headgear</a</li>
                  ...
                  return (
                    <div key={index}>
                      ...
                      <div className={styles.colorlist}>
                        {
                          c.colours && c.colours.map((col, index) => {
                            return (
                              <div className={styles.dot} style={{ backgroundColor: col }} />
                            )
